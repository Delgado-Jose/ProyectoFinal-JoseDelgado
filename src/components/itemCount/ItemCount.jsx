...
export const ItemCount = ({ stock, addToCart, actualizaStock }) => {
  ...
  return (
    <div className="flex-col items-center space-y-2">
      ...
      <Button clase="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mt-2" funcion={handleAddToCart} texto="Agregar al Carrito" />
    </div>
  )
}
